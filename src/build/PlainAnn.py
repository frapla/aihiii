...
class PlainAnn(BasePipe):
    ...
    def _set_feature_extractor(self, temp_in: Input) -> None:
        ...
        temp_block = Flatten(data_format=self._channel_format)(feature_extractor_in)
...
if __name__ == "__main__":
    ...
    checker = CheckPipe(pipe=PlainAnn, n_samples=5)
    if False:
