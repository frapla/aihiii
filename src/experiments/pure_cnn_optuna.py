...
class HyperGenerator(BaseHyperparameterGenerator):
    ...
    def suggest_hyperparameter(self, trial: optuna.Trial) -> Hyperparameter:
        ...
        elif file_names_ai_in == "channels_tsfresh":
            params.file_names_ai_in = ["channels"]  # , "tsfresh_features_50"]
        else:
            params.file_names_ai_in = ["channels", "injury_criteria"]  # , "tsfresh_features_50"]
...
def test():
    ...
    database = "virthuman"  # "doe_sobol_20240705_194200"

    cwd = os.getcwd()
    # work_dir = (
    #    Path("experiments")
    #    / "2024-09-12-19-34-27_pure_cnn_optuna_virthuman"
    # )
    work_dir = Path("experiments/2024-09-12-19-34-27_pure_cnn_optuna_virthuman")
