...
def test() -> None:
    ...
    parser.add_argument("--perc", type=int, default=5)
    parser.add_argument("--tgt", type=str, default="injury_criteria")
    parser.add_argument("--database", type=str, default="doe_sobol_20240705_194200")

    args = parser.parse_args()

    run(perc=args.perc, tgt=args.tgt, database=args.database)
